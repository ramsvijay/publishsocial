...
public class CreatePhotoPostWithURL extends Choreography {
	...
	*/
	public CreatePhotoPostWithURLInputSet newInputSet() {
	 ...
	 */
	 @Override
	public CreatePhotoPostWithURLResultSet execute(InputSet choreoInputs) throws TembooException {
	...
	*/
	public static class CreatePhotoPostWithURLInputSet extends InputSet {
		/** 
	...
	*/
	public static class CreatePhotoPostWithURLResultSet extends ResultSet {
		public CreatePhotoPostWithURLResultSet(JSONObject doc) throws TembooException {
			super(doc);
		}
