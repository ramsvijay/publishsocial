...
public class EditPhotoPostWithURL extends Choreography {
	...
	*/
	public EditPhotoPostWithURLInputSet newInputSet() {
	 ...
	 */
	 @Override
	public EditPhotoPostWithURLResultSet execute(InputSet choreoInputs) throws TembooException {
	...
	*/
	public static class EditPhotoPostWithURLInputSet extends InputSet {
		/** 
	...
	*/
	public static class EditPhotoPostWithURLResultSet extends ResultSet {
		public EditPhotoPostWithURLResultSet(JSONObject doc) throws TembooException {
			super(doc);
		}
