...
public class RetrieveSubmissionPosts extends Choreography {
	...
	*/
	public RetrieveSubmissionPostsInputSet newInputSet() {
	 ...
	 */
	 @Override
	public RetrieveSubmissionPostsResultSet execute(InputSet choreoInputs) throws TembooException {
	...
	*/
	public static class RetrieveSubmissionPostsInputSet extends InputSet {
		/** 
	...
	*/
	public static class RetrieveSubmissionPostsResultSet extends ResultSet {
		public RetrieveSubmissionPostsResultSet(JSONObject doc) throws TembooException {
			super(doc);
		}
