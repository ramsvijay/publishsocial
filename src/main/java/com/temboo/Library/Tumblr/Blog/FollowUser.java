...
public class FollowUser extends Choreography {
	...
	*/
	public FollowUserInputSet newInputSet() {
	 ...
	 */
	 @Override
	public FollowUserResultSet execute(InputSet choreoInputs) throws TembooException {
	...
	*/
	public static class FollowUserInputSet extends InputSet {
		/** 
	...
	*/
	public static class FollowUserResultSet extends ResultSet {
		public FollowUserResultSet(JSONObject doc) throws TembooException {
			super(doc);
		}
