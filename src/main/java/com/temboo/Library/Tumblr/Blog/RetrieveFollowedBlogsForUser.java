...
public class RetrieveFollowedBlogsForUser extends Choreography {
	...
	*/
	public RetrieveFollowedBlogsForUserInputSet newInputSet() {
	 ...
	 */
	 @Override
	public RetrieveFollowedBlogsForUserResultSet execute(InputSet choreoInputs) throws TembooException {
	...
	*/
	public static class RetrieveFollowedBlogsForUserInputSet extends InputSet {
		/** 
	...
	*/
	public static class RetrieveFollowedBlogsForUserResultSet extends ResultSet {
		public RetrieveFollowedBlogsForUserResultSet(JSONObject doc) throws TembooException {
			super(doc);
		}
