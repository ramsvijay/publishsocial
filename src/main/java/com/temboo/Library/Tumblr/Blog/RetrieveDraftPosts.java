...
public class RetrieveDraftPosts extends Choreography {
	...
	*/
	public RetrieveDraftPostsInputSet newInputSet() {
	 ...
	 */
	 @Override
	public RetrieveDraftPostsResultSet execute(InputSet choreoInputs) throws TembooException {
	...
	*/
	public static class RetrieveDraftPostsInputSet extends InputSet {
		/** 
	...
	*/
	public static class RetrieveDraftPostsResultSet extends ResultSet {
		public RetrieveDraftPostsResultSet(JSONObject doc) throws TembooException {
			super(doc);
		}
