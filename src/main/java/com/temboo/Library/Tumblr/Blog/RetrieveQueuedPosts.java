...
public class RetrieveQueuedPosts extends Choreography {
	...
	*/
	public RetrieveQueuedPostsInputSet newInputSet() {
	 ...
	 */
	 @Override
	public RetrieveQueuedPostsResultSet execute(InputSet choreoInputs) throws TembooException {
	...
	*/
	public static class RetrieveQueuedPostsInputSet extends InputSet {
		/** 
	...
	*/
	public static class RetrieveQueuedPostsResultSet extends ResultSet {
		public RetrieveQueuedPostsResultSet(JSONObject doc) throws TembooException {
			super(doc);
		}
