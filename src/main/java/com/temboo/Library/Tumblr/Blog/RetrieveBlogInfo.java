...
public class RetrieveBlogInfo extends Choreography {
	...
	*/
	public RetrieveBlogInfoInputSet newInputSet() {
	 ...
	 */
	 @Override
	public RetrieveBlogInfoResultSet execute(InputSet choreoInputs) throws TembooException {
	...
	*/
	public static class RetrieveBlogInfoInputSet extends InputSet {
		/** 
	...
	*/
	public static class RetrieveBlogInfoResultSet extends ResultSet {
		public RetrieveBlogInfoResultSet(JSONObject doc) throws TembooException {
			super(doc);
		}
