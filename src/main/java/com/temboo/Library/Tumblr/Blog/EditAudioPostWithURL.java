...
public class EditAudioPostWithURL extends Choreography {
	...
	*/
	public EditAudioPostWithURLInputSet newInputSet() {
	 ...
	 */
	 @Override
	public EditAudioPostWithURLResultSet execute(InputSet choreoInputs) throws TembooException {
	...
	*/
	public static class EditAudioPostWithURLInputSet extends InputSet {
		/** 
	...
	*/
	public static class EditAudioPostWithURLResultSet extends ResultSet {
		public EditAudioPostWithURLResultSet(JSONObject doc) throws TembooException {
			super(doc);
		}
