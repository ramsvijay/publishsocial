...
public class CreateLinkPost extends Choreography {
	...
	*/
	public CreateLinkPostInputSet newInputSet() {
	 ...
	 */
	 @Override
	public CreateLinkPostResultSet execute(InputSet choreoInputs) throws TembooException {
	...
	*/
	public static class CreateLinkPostInputSet extends InputSet {
		/** 
	...
	*/
	public static class CreateLinkPostResultSet extends ResultSet {
		public CreateLinkPostResultSet(JSONObject doc) throws TembooException {
			super(doc);
		}
