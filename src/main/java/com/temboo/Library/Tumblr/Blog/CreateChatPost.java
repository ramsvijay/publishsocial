...
public class CreateChatPost extends Choreography {
	...
	*/
	public CreateChatPostInputSet newInputSet() {
	 ...
	 */
	 @Override
	public CreateChatPostResultSet execute(InputSet choreoInputs) throws TembooException {
	...
	*/
	public static class CreateChatPostInputSet extends InputSet {
		/** 
	...
	*/
	public static class CreateChatPostResultSet extends ResultSet {
		public CreateChatPostResultSet(JSONObject doc) throws TembooException {
			super(doc);
		}
