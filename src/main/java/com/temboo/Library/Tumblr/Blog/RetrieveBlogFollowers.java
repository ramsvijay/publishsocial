...
public class RetrieveBlogFollowers extends Choreography {
	...
	*/
	public RetrieveBlogFollowersInputSet newInputSet() {
	 ...
	 */
	 @Override
	public RetrieveBlogFollowersResultSet execute(InputSet choreoInputs) throws TembooException {
	...
	*/
	public static class RetrieveBlogFollowersInputSet extends InputSet {
		/** 
	...
	*/
	public static class RetrieveBlogFollowersResultSet extends ResultSet {
		public RetrieveBlogFollowersResultSet(JSONObject doc) throws TembooException {
			super(doc);
		}
