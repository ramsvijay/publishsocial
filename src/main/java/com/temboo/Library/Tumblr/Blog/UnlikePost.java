...
public class UnlikePost extends Choreography {
	...
	*/
	public UnlikePostInputSet newInputSet() {
	 ...
	 */
	 @Override
	public UnlikePostResultSet execute(InputSet choreoInputs) throws TembooException {
	...
	*/
	public static class UnlikePostInputSet extends InputSet {
		/** 
	...
	*/
	public static class UnlikePostResultSet extends ResultSet {
		public UnlikePostResultSet(JSONObject doc) throws TembooException {
			super(doc);
		}
