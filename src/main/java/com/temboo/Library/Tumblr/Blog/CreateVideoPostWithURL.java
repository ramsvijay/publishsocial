...
public class CreateVideoPostWithURL extends Choreography {
	...
	*/
	public CreateVideoPostWithURLInputSet newInputSet() {
	 ...
	 */
	 @Override
	public CreateVideoPostWithURLResultSet execute(InputSet choreoInputs) throws TembooException {
	...
	*/
	public static class CreateVideoPostWithURLInputSet extends InputSet {
		/** 
	...
	*/
	public static class CreateVideoPostWithURLResultSet extends ResultSet {
		public CreateVideoPostWithURLResultSet(JSONObject doc) throws TembooException {
			super(doc);
		}
