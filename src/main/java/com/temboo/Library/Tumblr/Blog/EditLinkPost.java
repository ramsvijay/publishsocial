...
public class EditLinkPost extends Choreography {
	...
	*/
	public EditLinkPostInputSet newInputSet() {
	 ...
	 */
	 @Override
	public EditLinkPostResultSet execute(InputSet choreoInputs) throws TembooException {
	...
	*/
	public static class EditLinkPostInputSet extends InputSet {
		/** 
	...
	*/
	public static class EditLinkPostResultSet extends ResultSet {
		public EditLinkPostResultSet(JSONObject doc) throws TembooException {
			super(doc);
		}
