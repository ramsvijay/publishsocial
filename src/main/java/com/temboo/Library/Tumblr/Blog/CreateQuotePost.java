...
public class CreateQuotePost extends Choreography {
	...
	*/
	public CreateQuotePostInputSet newInputSet() {
	 ...
	 */
	 @Override
	public CreateQuotePostResultSet execute(InputSet choreoInputs) throws TembooException {
	...
	*/
	public static class CreateQuotePostInputSet extends InputSet {
		/** 
	...
	*/
	public static class CreateQuotePostResultSet extends ResultSet {
		public CreateQuotePostResultSet(JSONObject doc) throws TembooException {
			super(doc);
		}
