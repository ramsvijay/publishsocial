...
public class EditVideoPostWithURL extends Choreography {
	...
	*/
	public EditVideoPostWithURLInputSet newInputSet() {
	 ...
	 */
	 @Override
	public EditVideoPostWithURLResultSet execute(InputSet choreoInputs) throws TembooException {
	...
	*/
	public static class EditVideoPostWithURLInputSet extends InputSet {
		/** 
	...
	*/
	public static class EditVideoPostWithURLResultSet extends ResultSet {
		public EditVideoPostWithURLResultSet(JSONObject doc) throws TembooException {
			super(doc);
		}
