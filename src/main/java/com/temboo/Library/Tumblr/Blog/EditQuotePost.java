...
public class EditQuotePost extends Choreography {
	...
	*/
	public EditQuotePostInputSet newInputSet() {
	 ...
	 */
	 @Override
	public EditQuotePostResultSet execute(InputSet choreoInputs) throws TembooException {
	...
	*/
	public static class EditQuotePostInputSet extends InputSet {
		/** 
	...
	*/
	public static class EditQuotePostResultSet extends ResultSet {
		public EditQuotePostResultSet(JSONObject doc) throws TembooException {
			super(doc);
		}
