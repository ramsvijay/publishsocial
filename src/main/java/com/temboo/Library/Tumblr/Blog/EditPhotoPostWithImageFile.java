...
public class EditPhotoPostWithImageFile extends Choreography {
	...
	*/
	public EditPhotoPostWithImageFileInputSet newInputSet() {
	 ...
	 */
	 @Override
	public EditPhotoPostWithImageFileResultSet execute(InputSet choreoInputs) throws TembooException {
	...
	*/
	public static class EditPhotoPostWithImageFileInputSet extends InputSet {
		/** 
	...
	*/
	public static class EditPhotoPostWithImageFileResultSet extends ResultSet {
		public EditPhotoPostWithImageFileResultSet(JSONObject doc) throws TembooException {
			super(doc);
		}
