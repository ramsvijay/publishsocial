...
public class CreateAudioPostWithURL extends Choreography {
	...
	*/
	 ...
	 */
	 @Override
	public CreateAudioPostWithURLResultSet execute(InputSet choreoInputs) throws TembooException {
	...
	*/
	public static class CreateAudioPostWithURLInputSet extends InputSet {
		/** 
	...
	*/
	public static class CreateAudioPostWithURLResultSet extends ResultSet {
		public CreateAudioPostWithURLResultSet(JSONObject doc) throws TembooException {
			super(doc);
		}
