...
public class CreateTextPost extends Choreography {
	...
	*/
	public CreateTextPostInputSet newInputSet() {
	 ...
	 */
	 @Override
	public CreateTextPostResultSet execute(InputSet choreoInputs) throws TembooException {
	...
	*/
	public static class CreateTextPostInputSet extends InputSet {
		/** 
	...
	*/
	public static class CreateTextPostResultSet extends ResultSet {
		public CreateTextPostResultSet(JSONObject doc) throws TembooException {
			super(doc);
		}
