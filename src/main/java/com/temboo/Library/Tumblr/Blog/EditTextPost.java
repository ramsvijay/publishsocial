...
public class EditTextPost extends Choreography {
	...
	*/
	public EditTextPostInputSet newInputSet() {
	 ...
	 */
	 @Override
	public EditTextPostResultSet execute(InputSet choreoInputs) throws TembooException {
	...
	*/
	public static class EditTextPostInputSet extends InputSet {
		/** 
	...
	*/
	public static class EditTextPostResultSet extends ResultSet {
		public EditTextPostResultSet(JSONObject doc) throws TembooException {
			super(doc);
		}
